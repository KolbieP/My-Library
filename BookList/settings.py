...
SECRET_KEY = 'django-insecure-+id()#sfvltsn&g#9y$)2(=ktxa!pejg25ko14sz*z6h0ku&tv'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG = True
DEBUG = False

ALLOWED_HOSTS = ['KolbieP.pythonanywhere.com']
...
DATABASES = {
    ...
    'public_library': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'public_library.sqlite3',
    },
}

# Database Routers
DATABASE_ROUTERS = ['db_routers.PublicLibraryRouter']
...
#This makes it so that the books are displayed only 10 per page
REST_FRAMEWORK = {
